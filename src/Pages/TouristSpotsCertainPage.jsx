...
const TouristSpotsCertainPage = () => {
  ...
  const spot = Object.values(sections)
    .flat()
    .find((s) => s.link === `/${spotId}`);

  if (!spot) {
    return (
      <p className="text-center mt-20 text-lg font-medium">Spot not found!</p>
    );
  }
  ...
  return (
    <div className="flex flex-col items-center mt-12 mb-12 px-4 sm:px-8">
      ...
      {/* Google Maps */}
      <h2 className="text-xl sm:text-2xl font-bold mt-12 mb-6 text-center">
        Location
      </h2>
