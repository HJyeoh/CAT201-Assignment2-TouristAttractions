...
const TouristSpotsPage = () => {
  ...
  return (
    <div className="container mx-auto py-6 px-4 sm:px-8">
      ...
      <div className="mb-8 mt-8 flex flex-col sm:flex-row justify-center items-center space-x-0 sm:space-x-4 space-y-4 sm:space-y-0">
        {/* Category Filter */}
          ...
          getFilteredSpots().map((spot, index) => (
            <Link to={spot.link} key={index} className="text-center">
              <img
                src={spot.img}
                alt={spot.name}
                className="w-40 h-40 object-cover mb-2 sm:mb-3 rounded-full mx-auto"
              />
