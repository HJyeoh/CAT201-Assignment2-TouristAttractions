...
export default function Navbar() {
  return (
    <Disclosure as="nav" className="absolute top-0 w-full bg-black/50">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-20 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:ml-6 sm:block lg:ml-[19%]">
              <div className="flex items-center text-center justify-center space-x-4 h-full ">
                {navigation.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
