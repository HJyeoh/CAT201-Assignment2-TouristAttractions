...
const navigation = [
  ...
  { name: 'Tourist Spots', href: '/touristSpots', current: false },
  { name: 'Food & Beverages', href: '/food', current: false },
  { name: 'Hotels', href: '/hotel', current: false },
  { name: 'Events & Festivals', href: '/events', current: false },
];

// Utility function for handling conditional classes
